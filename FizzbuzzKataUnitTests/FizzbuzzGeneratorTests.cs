...
namespace FizzbuzzKataUnitTests
{
    ...
    public class FizzbuzzGeneratorTests
    {
        ...
        {
            var resultSet = _fizzbuzzGenerator.GenerateResultsBetween(0, 0);
        ...
        {
            var resultSet = _fizzbuzzGenerator.GenerateResultsBetween(1, 100);
        ...
        {
            var resultSet = _fizzbuzzGenerator.GenerateResultsBetween(1, 9);
        ...
        {
            var resultSet = _fizzbuzzGenerator.GenerateResultsBetween(1, 3);
        ...
        {
            var resultSet = _fizzbuzzGenerator.GenerateResultsBetween(1, 5);
        ...
        {
            var resultSet = _fizzbuzzGenerator.GenerateResultsBetween(1, 15);
